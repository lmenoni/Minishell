...
NAME	= minishell
SRC	 	= main.c token_utils.c free_mem.c utils.c tokenization.c cmd_array.c cmd_array_utils.c env.c print.c here_doc.c expansion.c utils_2.c manage_expansion.c new_tokens_utils.c utils_3.c
HEADERS = minishell.h
OBJ_DIR = obj
