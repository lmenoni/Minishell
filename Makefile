...
#    Updated: 2025/05/16 18:14:56 by lmenoni          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME	= minishell
SRC	 	= main.c token_utils.c free_mem.c utils.c tokenization.c cmd_array.c cmd_array_utils.c env.c print.c here_doc.c
HEADERS = minishell.h
OBJ_DIR = obj
